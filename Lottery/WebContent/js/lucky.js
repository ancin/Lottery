...
define(function(require, exports, module) {
    ...
    function User(name,uid, options) {
        this.name = name;
        this.uid = uid;
    ...
    User.prototype.createEl = function() {
        this.el = $('<li data-uid="'+this.uid+'">' + this.name + '</li>').appendTo('#balls')
    ...
    module.exports = {
        ...
        init: function(data) {
            ...
            this.users = data.map(function(eachUser) {
                return new User(eachUser.name, eachUser.uid);
            })
